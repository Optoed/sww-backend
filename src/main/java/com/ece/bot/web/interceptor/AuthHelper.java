...
public class AuthHelper {
    ...
    public static boolean isValid(String telegramInitData, String botToken, String hash) throws Exception {
        ...
        System.out.println(secretKey[0] + " " + secretKey[1] + " " + secretKey[secretKey.length - 1]);
